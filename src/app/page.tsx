...
export default function Home() {
  return (
    <div>
      ...
      <p className="text-lg mb-4">
        While we are mostly located in the greater Portland, OR metro area, we have members spread out from Salem, OR to Seattle, WA.
      </p>
      <p className="text-lg mb-4">
      ...
      <ul></ul>
      <div className="mx-auto m-4 w-2xs border-t border-gray-400" />
